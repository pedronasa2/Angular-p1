...
// node_modules/devextreme/esm/__internal/core/localization/default_messages.js
var defaultMessages = {
  en: {
    Yes: "Yes",
    No: "No",
...
// node_modules/devextreme/esm/__internal/core/localization/message.js
...
var messageLocalization = injector({
  ...
  _getFormatterBase(key, _locale) {
    const message = core_default.getValueByClosestLocale((locale) => getDataByLocale(this._dictionary, locale)[key]);
    if (message) {
      return function() {
...
//# sourceMappingURL=chunk-EMRGXNWD.js.map
