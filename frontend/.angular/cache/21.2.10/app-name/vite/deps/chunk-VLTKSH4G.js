...
var Overlay = class _Overlay extends widget_default {
  ...
  _documentDownHandler(e) {
    ...
    const isTargetInContent = content ? m_dom_default.contains(content, target) : false;
  ...
  _handleZIndexOptionChanged() {
    ...
    this._zIndex = zIndex ?? create(this._zIndexInitValue());
  ...
  _toggleHideOnParentsScrollSubscription(needSubscribe) {
    ...
    if (needSubscribe && hideOnParentScroll) {
      ...
      if ("desktop" === devices_default.real().deviceType) {
        var _$parents;
        $parents = null === (_$parents = $parents) || void 0 === _$parents ? void 0 : _$parents.add(window2);
      }
...
//# sourceMappingURL=chunk-VLTKSH4G.js.map
